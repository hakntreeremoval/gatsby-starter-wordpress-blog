...
import { Add, Nature,RestoreFromTrash, Warning,AttachMoney,Spa } from "@material-ui/icons"
          ...
          <CardContent>
            <div className={classes.root + " w-100 h-100"}>
                ...
                <Typography variant="h3" align="left" className={classes.typography} id="discrete-slider-always" gutterBottom>
                  HEIGHT OF TREE (in meters) {/*in metres, cap at 1.5 metres (excessive is a regulated tree)*/}
                </Typography>
                <Slider
                  step={.5}
                  max={12}
                ...
                {/* prettier-ignore */}
                <Typography variant="h3" align="left" className={classes.typography} id="discrete-slider-always" gutterBottom >
                  WIDTH OF TREE (in centimetres) {/*in centimetres, cap at 12cm*/}
                </Typography>
                <Slider
                  step={10}
                  defaultValue={30}
